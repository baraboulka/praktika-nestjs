...
export class SubjectsController {
    ...
    @Post()
    createSubject(@Body() createSubjectDto: CreateSubjectDto): Promise<SchoolSubject> {
        return this.subjectService.createSubject(createSubjectDto)
    }

    @Put() 
    updateSubjects(@Body() updateSubjectsDto: UpdateSubjectDto[]): Promise<Promise<SchoolSubject>[]> {
